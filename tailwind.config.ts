    ...
    theme: {
      ...
      extend: {
        ...
        fontWeight: {
          ...
          extralight: '200',
          light: '300',
          normal: '300', // Was 400, now Light
          medium: '400', // Was 500, now Regular
          semibold: '500', // Was 600, now Medium
          bold: '600', // Was 700, now SemiBold
          extrabold: '700', // Was 800, now Bold
          black: '900',
        },
        colors: {
          border: {
          ...
          'background-destructive': {
            ...
            border: 'hsl(var(--background-destructive-border))',
          },
          'dark-active': {
            DEFAULT: 'hsl(var(--grey3))',
