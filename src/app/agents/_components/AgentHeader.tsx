...
export function AgentHeader({ agent }: AgentHeaderProps) {
  ...
  // GitHub URLs
  const downloadUrl = `https://raw.githubusercontent.com/letta-ai/agent-file/refs/heads/main/agents/${ownerId}/${agentKey}/${agentKey}.af`;
  const githubUrl = `https://github.com/letta-ai/agent-file/blob/main/agents/${ownerId}/${agentKey}`;
